    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errData.message || 'Erro ao cadastrar usuário no banco de dados.');
            }
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', background: '#fff', padding: '2rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem' }}>
                    ...
                    <tbody>
                        {users.length === 0 ? (
                            <tr>
                                <td colSpan="3" style={{ padding: '1rem', textAlign: 'center', color: '#666' }}>Nenhum usuário cadastrado.</td>
                            </tr>
                        ) : (
                            users.map(u => (
                                <tr key={u.id || u.email} style={{ borderBottom: '1px solid #ddd' }}>
